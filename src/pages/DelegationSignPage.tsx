...
const SCOPE_ITEMS = [
  "퇴직 의사의 통지 및 관련 서면의 작성·발송·수령",
  "회사 및 파견업체 측과의 연락 수령·회신·협의",
  "임금 등 금품 정산에 관한 협의",
  "퇴직 관련 서류(사직 관련 서식, 이직확인서, 경력증명서 등)의 요청·수령·전달",
];
      ...
      <main className="calc-main" style={{ maxWidth: 640 }}>
        <div className="checkout-terms">
          ...
          <p style={{ fontSize: 14, lineHeight: 1.7 }}>
            ...
            연제구 법원남로15번길 10, 202호 · ☎ 1660-4452)에게, 본인의 퇴직과
            관련한 아래 사무의 처리를 위임하였음을 확인하며, 이 건에 관한 연락은
            수임인을 통하여 주실 것을 요청합니다.
          </p>
          <ul>
            {SCOPE_ITEMS.map((s) => (
              <li key={s}>{s}</li>
