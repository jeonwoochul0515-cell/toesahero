...
const CONFIG: Record<Seg, Config> = {
  ...
  "unfair-dismissal": {
    ...
    sub: "정당한 이유도, 절차도 없는 해고는 무효가 될 수 있습니다. 노동위원회 구제신청부터, 당신 대신 변호사가 다툽니다.",
    ...
    points: [
      ...
      {
        h: "서면 통지가 없으면 무효가 될 수 있습니다",
        // 5인 미만 단서 — 시행령 별표1(§23②·§26만 적용, §23①·§27·§28 미적용) 법제처 원문 확인 2026-09-25
        body: "제27조는 해고 사유와 시기를 반드시 '서면'으로 통지하도록 합니다. 구두·문자·카톡 해고, 또는 사유를 적지 않은 통지는 절차 위반으로 무효가 될 수 있습니다. 다만 상시 5인 미만 사업장에는 정당한 이유(제23조 제1항)·서면 통지(제27조)·노동위원회 구제신청 규정이 적용되지 않습니다.",
      },
      {
        h: "3개월 안에 구제신청해야 합니다",
      ...
      {
        h: "해고만이 아닙니다 — 전보·징계·감봉도 다툴 수 있습니다",
        body: "근로기준법 제23조 제1항은 정당한 이유 없는 '해고·전직(전보)·정직·감봉·징벌'을 함께 금지합니다. 괴롭힘 신고 뒤 지방으로 발령하거나 한직으로 보내는 부당전보도 부당해고와 같은 절차로 노동위원회 구제신청 대상입니다.",
      },
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        a: "업무상 필요와 정당한 이유 없이, 특히 신고에 대한 보복으로 이뤄진 전보는 부당전보로 다툴 수 있습니다. 부당해고와 동일하게 발령일부터 3개월 내 노동위원회 구제신청 대상이며, 생활상 불이익과 절차적 정당성을 함께 검토합니다.",
      },
    ],
  },
  "unpaid-wages": {
  ...
  "severance-pay": {
    ...
    sub: "4주 평균 주 15시간 이상, 1년 이상 일했다면 퇴직금은 당연한 권리입니다. 5인 미만도, 알바도 예외가 아닙니다.",
