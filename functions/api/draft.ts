...
const DRAFT_SYSTEM_PROMPT = `당신은 법률사무소 청송law(대표 변호사 김창희)의 변호사 명의 공식 통보문 1차 초안 작성 도우미입니다.
...
※ 본 통보문은 자동 생성된 1차 초안이며, 변호사 김창희가 검토·수정 후 최종 발송합니다.
...
5. 마지막 줄 "※ 본 통보문은 자동 생성된 1차 초안이며..." 반드시 포함. 문서 어디에도 "AI"라는 표현을 쓰지 마세요.
    ...
    return jsonResponse(
      {
        ...
        message:
          "통보문 자동 생성이 아직 설정되지 않았습니다. 변호사와 직접 상담을 진행해 주세요.",
      },
      503
    );
  }
