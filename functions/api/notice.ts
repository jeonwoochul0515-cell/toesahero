...
const NOTICE_SYSTEM_PROMPT = `당신은 법률사무소 청송law(대표 변호사 김창희)의 변호사 명의 내용증명 1차 초안 작성 도우미입니다.
...
[작성일] [YYYY년 MM월 DD일]
[법률대리인] 법률사무소 청송law 대표 변호사 김창희 (인)
────────────────────

※ 본 내용증명은 자동 생성된 1차 초안이며, 변호사 김창희가 사실관계 검증 및 법적 검토 후 최종 발송합니다.
...
4. 마지막 줄 "※ 본 내용증명은 자동 생성된 1차 초안..." 반드시 포함. 문서 어디에도 "AI"라는 표현을 쓰지 마세요.
5. 청구액 합계 자동 계산 + 명시.
    ...
    return jsonResponse(
      {
        ...
        message:
          "내용증명 자동 생성이 아직 설정되지 않았습니다. 변호사와 직접 상담을 진행해 주세요.",
      },
      503
    );
  }
