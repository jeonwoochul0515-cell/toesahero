...
> 변호사가 직접 운영하는 합법 퇴사대행 서비스. 법률사무소 청송law(부산)의 김창희 변호사가 통보부터 임금 회수·분쟁 대응까지 직접 수행합니다. 노무사 운영 업체와 달리, 분쟁이 격화되는 대리·교섭·소송 단계도 같은 사무소에서 일관 처리합니다.

## 운영 주체
- 법률사무소 청송law / 대표 변호사 김창희
