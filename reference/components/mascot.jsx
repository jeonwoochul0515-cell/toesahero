// 퇴사히어로 마스코트 — 망토 두른 단순 도형 캐릭터
function Mascot({ size = 80, pose = "stand", className = "", style = {} }) {
  // pose: stand | wave | fly | wink | shock
  const s = size;
  return (
    <svg
    ...
    >
      ...
      {/* mask band */}
      <path
        d="M26 44 Q50 38 74 44 L74 50 Q50 46 26 50 Z"
        fill="#0A0A0A"
      />
      {/* eyes */}
      {pose === "wink" ? (
        <>
          ...
          <path d="M56 48 Q60 46 64 48" stroke="#FFFBF0" strokeWidth="2" fill="none" strokeLinecap="round" />
        </>
      ) : pose === "shock" ? (
        <>
      ...
      {pose === "shock" ? (
        ...
        <path d="M44 58 Q50 64 56 58" stroke="#0A0A0A" strokeWidth="2.5" fill="none" strokeLinecap="round" />
      ) : (
        <path d="M44 60 Q50 64 56 60" stroke="#0A0A0A" strokeWidth="2.5" fill="none" strokeLinecap="round" />
      )}
      {/* cheek dots */}
      ...
      <g transform="translate(50 70)">
        <rect x="-7" y="-4" width="14" height="9" rx="2" fill="#FF6B35" stroke="#0A0A0A" strokeWidth="1.5" />
        <text x="0" y="3" textAnchor="middle" fill="#FFFBF0" fontSize="7" fontWeight="900" fontFamily="Space Grotesk, sans-serif">H</text>
      </g>
      {/* waving arm */}
      {pose === "wave" && (
        <g>
